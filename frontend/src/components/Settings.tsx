...
export function Settings(props: Props) {
  ...
  return (
    <div
      className={`h-screen w-screen absolute z-50 grid place-items-center ${props.hidden ? "hidden" : ""}`}
    >
      <div
        className={
          "bg-gray-800 h-120 w-80 rounded-xl p-2 border-1 border-gray-700 flex flex-col gap-4"
        }
      >
        ...
        <div className={"flex flex-col gap-1"}>
          <a
            className={"bg-purple-500 text-zinc-100 font-semibold p-2 rounded"}
            href={
          ...
          <p
            className={`${!twitchConnected ? "text-red-400" : "text-green-400"}`}
          >
