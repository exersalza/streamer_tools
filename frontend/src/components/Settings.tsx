    ...
    <div className={`h-screen w-screen absolute z-50 grid place-items-center ${props.hidden ? "hidden" : ""}`}>
      <div className={"bg-gray-800 h-120 w-80 rounded-xl p-2 border-1 border-gray-700 flex flex-col gap-4"}>
        ...
        <div className={"flex flex-col gap-1"}>
          <a className={"bg-purple-500 text-zinc-100 font-semibold p-2 rounded"} href={"https://id.twitch.tv/oauth2/authorize?response_type=code&client_id=2i56tfmomtm0a3m3m5w83boazvkaks&force_verify=true&redirect_uri=http://localhost:22727/api/v1/twitch_auth&scope=channel:read:subscriptions+moderator:read:followers&"}>Connect with Twitch</a>
